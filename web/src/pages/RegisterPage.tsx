    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
      ...
      >
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold text-brand-primary">Реєстрація</h1>
        </div>
        ...
        >
          Пароль
          <PasswordInput value={password} onChange={setPassword} autoComplete="new-password" className={INPUT_CLASS} />
